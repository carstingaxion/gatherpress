...
const displayDateTime = (start, end, tz) => {
  ...
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('%1$s to %2$s %3$s', 'gatherpress'), moment__WEBPACK_IMPORTED_MODULE_1___default().tz(start, timeZone).format(startFormat), moment__WEBPACK_IMPORTED_MODULE_1___default().tz(end, timeZone).format(endFormat), (0,_helpers_datetime__WEBPACK_IMPORTED_MODULE_7__.getUtcOffset)(timeZone));
};
